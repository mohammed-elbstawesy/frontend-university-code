...
export class Stats implements OnInit {
  ...
  stats = [
    ...
    // قمت بتغيير التسمية لتكون أدق
    { label: 'Total Issues Found', value: 0, color: 'text-green-500', bg: 'bg-green-500/10', iconPath: 'M5 10L8 13L15 6' },
    { label: 'Tracked URLs', value: 0, color: 'text-purple-500', bg: 'bg-purple-500/10', iconPath: 'M8 12L12 8M10 2C5.58172 2 2 5.58172 2 10C2 14.4183 5.58172 18 10 18C14.4183 18 18 14.4183 18 10C18 5.58172 14.4183 2 10 2Z' },
    { label: 'Reports Generated', value: 0, color: 'text-[#ff003c]', bg: 'bg-[#ff003c]/10', iconPath: 'M6 2H14C15.1 2 16 2.9 16 4V18L10 15L4 18V4C4 2.9 4.9 2 6 2Z' }
  ];
