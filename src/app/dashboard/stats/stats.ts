...
constructor(
  ...
  stats = [
    ...
    { label: 'Resolved', value: this.numberOfResult, color: 'text-green-500', bg: 'bg-green-500/10', iconPath: 'M5 10L8 13L15 6' },
...
this._result.getResult().subscribe({
  next:(res)=>{
    this.result = res    
    this.numberOfResult = this.result.length;
    this.stats[3].value=this.numberOfResult
    console.log('results:', this.numberOfResult);
  },
